...
public static class Services
{
    ...
    /// </summary>
    public const string Database = "modular_mlm";

    /// <summary>
    /// The Aspire-safe resource name for the database. The physical database and connection-string
