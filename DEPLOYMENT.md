...
into a frontend image. On a new database, the migration job creates the roles,
published bootstrap organization, and first platform administrator, then assigns
that administrator to `ORGANIZATION_SLUG`.
